...
namespace AdsWrapper
{
    ...
    public:
        ...
        /// Safe to call even if <see cref="Subscrube"/> was not called or already stopped.
        /// </summary>
        void Unsubscribe();
    ...
    private:
        ...
        bool               _disposed;
        bool               _subscribed;  ///< True after Start() succeeds, false after Stop()
